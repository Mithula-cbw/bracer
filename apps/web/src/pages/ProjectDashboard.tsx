          ...
          <div className="md:mt-auto md:border-t md:border-slate-800 md:pt-4">
            {isAuthed ? (
              <div className="flex items-center gap-3 cursor-pointer group px-1 md:px-2" onClick={() => setIsAuthed(false)}>
                <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-purple-500 to-indigo-500 text-white flex items-center justify-center font-bold text-sm shadow-sm group-hover:ring-2 ring-indigo-500 ring-offset-2 ring-offset-slate-900 transition-all">
                  U
                </div>
              ...
              <Button variant="secondary" onClick={() => setIsAuthed(true)} className="w-auto md:w-full bg-slate-800 hover:bg-slate-700 text-slate-200 border-slate-700 text-sm px-2 md:px-4">
                <svg className="w-4 h-4 md:mr-2" viewBox="0 0 24 24">
